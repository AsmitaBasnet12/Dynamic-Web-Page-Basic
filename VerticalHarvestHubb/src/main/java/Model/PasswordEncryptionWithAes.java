...
public class PasswordEncryptionWithAes {
    ...
    public static byte[]getRandomNonce(int numBytes){ //generate salt and IV for encryt and decrypt
    ...
    public static String encrypt(String user_name, String user_password) {
    	try {
            // 16 bytes salt
            ...
            byte[] cipherText = cipher.doFinal(user_password.getBytes());
